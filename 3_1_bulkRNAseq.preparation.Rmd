...
length(aernas2_setdif_samples_AERNAS2vsAEDBCEA) # 0 all AE > 0 this study
aernas2_setdif_samples_AEDBCEAvsAERNAS2 <- setdiff(study_samples_AEDBCEA, aernas2_study_samples_bulk)
length(aernas2_setdif_samples_AEDBCEAvsAERNAS2) # 2124 all AE > 2124 this study
...
# - includes 630 patients
# - after filtering on informed consent and artery type, the end sample size should be 621
...
cat("  > meta data\n")
temp_coldat <- data.frame(STUDY_NUMBER = names(aernas1_counts_raw_qc_umicorr_annotFilt[,10:630]), 
                          ...
                          row.names = names(aernas1_counts_raw_qc_umicorr_annotFilt[,10:630]))
...
```{r }
cat("* loading data ...\n")
temp1_coldat <- data.frame(STUDY_NUMBER = names(aernas1_counts_raw_qc_umicorr_annotFilt[,10:630]), 
                          SampleType = "plaque", RNAseqTech = "CEL2-seq", RNAseqType = "3' RNAseq", RNAseqQC = "UMI-corrected", 
                          StudyType = "CEA", StudyName = "AERNAS1", StudyBiobank = "Athero-Express Biobank Study (AE)", SampleSize = "622",
                          InformedConsent = "ACADEMIC",
                          row.names = names(aernas1_counts_raw_qc_umicorr_annotFilt[,10:630]))
...
cat("\n* removing intermediate files ...\n")
rm(temp1_coldat, temp2_coldat, temp_coldat_clin) # we don't delete 'temp_coldata_merge' because we need it later down the line
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAS1SEnorm.CEA.621pts.samplelist.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAS1SEnorm.CEA.621pts.clinicaldata.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
```
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAS1SEnorm.CEA.621pts.assay.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAS1SEnorm.CEA.621pts.rowRanges.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
```
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAS1SEvst.CEA.621pts.samplelist.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAS1SEvst.CEA.621pts.clinicaldata.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
```
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAS1SEvst.CEA.621pts.assay.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAS1SEvst.CEA.621pts.rowRanges.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
```
...
temp <- as.tibble(subset(colData(AERNAScomboSE), select = c("STUDY_NUMBER", "SampleType", "RNAseqTech", "RNAseqType", "RNAseqQC",
                                                        ...
                                                        "InformedConsent")))
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAScombo.CEA.1092pts.samplelist.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAScombo.CEA.1092pts.clinicaldata.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAScombo.CEA.1092pts.assay.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAScombo.CEA.1092pts.rowRanges.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
```
...
(AERNAScomboSEnorm <- SummarizedExperiment(assays = list(counts = normalized_counts),
                                colData = temp_coldat_clin,
                                rowRanges = combined_counts_rowRanges,
                                metadata = "Athero-Express RNAseq Study Combined: bulk RNA sequencing in carotid plaques accross two experiments, AERNAS1 (n=621) and AERNAS2 (n=471). Technology: CEL2-seq adapted for bulk RNA sequencing, thus 3'-focused. UMI-corrected. Size corrected normalization."))
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAScomboSEnorm.CEA.1092pts.samplelist.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAScomboSEnorm.CEA.1092pts.clinicaldata.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
```
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAScomboSEnorm.CEA.1092pts.assay.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAScomboSEnorm.CEA.1092pts.rowRanges.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
```
...
(AERNAScomboSEvst <- SummarizedExperiment(assays = list(counts = assay(AERNAScombovsd)),
                                colData = temp_coldat_clin,
                                rowRanges = combined_counts_rowRanges,
                                metadata = "Athero-Express RNAseq Study Combined: bulk RNA sequencing in carotid plaques accross two experiments, AERNAS1 (n=621) and AERNAS2 (n=471). Technology: CEL2-seq adapted for bulk RNA sequencing, thus 3'-focused. UMI-corrected. Size corrected normalization. log-transformed."))
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAScomboSEvst.CEA.1092pts.samplelist.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAScomboSEvst.CEA.1092pts.clinicaldata.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
```
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAScomboSEvst.CEA.1092pts.assay.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
...
fwrite(temp,
       file = paste0(OUT_loc, "/", Today, ".AERNAScomboSEvst.CEA.1092pts.rowRanges.after_qc.IC_academic.csv"),
       sep = ",", row.names = FALSE, col.names = TRUE,
       showProgress = TRUE)
rm(temp)
```
...
ggpubr::gghistogram(as.tibble(t(subset(assay(AERNAS1SE), AERNAS1SE@rowRanges$symbol == "HMOX1"))),
                    x = "ENSG00000100292", 
...
ggpubr::gghistogram(as.tibble(t(subset(assay(AERNAS1SEnorm), AERNAS1SEnorm@rowRanges$symbol == "HMOX1"))),
                    x = "ENSG00000100292", 
...
ggpubr::gghistogram(as.tibble(t(subset(assay(AERNAS1SEvst), AERNAS1SEvst@rowRanges$symbol == "HMOX1"))),
                    x = "ENSG00000100292", 
...
ggpubr::gghistogram(as.tibble(t(subset(assay(AERNAS2SE), AERNAS2SE@rowRanges$symbol == "HMOX1"))),
                    x = "ENSG00000100292", 
                    xlab = "HMOX1 (ENSG00000100292) expression\nraw counts | AERNAS2",
                    color = "white", fill =  uithof_color[8],
                    rug = F, add_density = F,
...
ggpubr::gghistogram(as.tibble(t(subset(assay(AERNAS2SEnorm), AERNAS2SEnorm@rowRanges$symbol == "HMOX1"))),
                    x = "ENSG00000100292", 
...
ggpubr::gghistogram(as.tibble(t(subset(assay(AERNAS2SEvst), AERNAS2SEvst@rowRanges$symbol == "HMOX1"))),
                    x = "ENSG00000100292", 
...
temp2 <- cbind(as.tibble(t(subset(assay(AERNAScomboSE), AERNAScomboSE@rowRanges$symbol == "HMOX1"))), temp)
ggpubr::gghistogram(temp2,
                    ...
                    ggtheme = theme_pubclean())
ggsave(filename = paste0(PLOT_loc, "/", Today, ".HMOX1_ENSG00000170323_GRCh38p13_EnsDb86.AERNACombinedRAW.CEA.1092pts.pdf"), device = "pdf", 
       dpi = 300, width = 12, height = 7, plot = last_plot())

temp = as.data.frame(colData(AERNAScomboSEnorm))
temp2 <- cbind(as.tibble(t(subset(assay(AERNAScomboSEnorm), AERNAScomboSEnorm@rowRanges$symbol == "HMOX1"))), temp)
ggpubr::gghistogram(temp2,
                    x = "ENSG00000100292", 
                    ...
                    add.params = list(linetype = 2), 
                    ggtheme = theme_pubclean())
ggsave(filename = paste0(PLOT_loc, "/", Today, ".HMOX1_ENSG00000170323_GRCh38p13_EnsDb86.AERNACombinedNORM.CEA.1092pts.pdf"), device = "pdf", 
       dpi = 300, width = 12, height = 7, plot = last_plot())

temp = as.data.frame(colData(AERNAScomboSEvst))
temp2 <- cbind(as.tibble(t(subset(assay(AERNAScomboSEvst), AERNAScomboSEvst@rowRanges$symbol == "HMOX1"))), temp)
ggpubr::gghistogram(temp2,
                    x = "ENSG00000100292", 
                    ...
                    add.params = list(linetype = 2), 
                    ggtheme = theme_pubclean())
ggsave(filename = paste0(PLOT_loc, "/", Today, ".HMOX1_ENSG00000170323_GRCh38p13_EnsDb86.AERNACombinedVST.CEA.1092pts.pdf"), device = "pdf", 
       dpi = 300, width = 12, height = 7, plot = last_plot())
...
saveRDS(AERNAS1SE, file = paste0(OUT_loc, "/", Today, ".AERNAS1.CEA.621pts.SE.after_qc.IC_academic.RDS"))
saveRDS(AERNAS1SEnorm, file = paste0(OUT_loc, "/", Today, ".AERNAS1SEnorm.CEA.621pts.SE.after_qc.IC_academic.RDS"))
saveRDS(AERNAS1SEvst, file = paste0(OUT_loc, "/", Today, ".AERNAS1SEvst.CEA.621pts.SE.after_qc.IC_academic.RDS"))
...
saveRDS(AERNAScomboSE, file = paste0(OUT_loc, "/", Today, ".AERNAScomboSE.CEA.1092pts.SE.after_qc.IC_academic.RDS"))
saveRDS(AERNAScomboSEnorm, file = paste0(OUT_loc, "/", Today, ".AERNAScomboSEnorm.CEA.1092pts.SE.after_qc.IC_academic.RDS"))
saveRDS(AERNAScomboSEvst, file = paste0(OUT_loc, "/", Today, ".AERNAScomboSEvst.CEA.1092pts.SE.after_qc.IC_academic.RDS"))
...
--------------------------------------------------------------------------------
    ...
    **Changes log**
    * v1.2.1 Small changes to the code due to sample selection (621 sample in AERNAS1, 471 samples in AERNAS2, and 1092 samples in AERNAScombo).
