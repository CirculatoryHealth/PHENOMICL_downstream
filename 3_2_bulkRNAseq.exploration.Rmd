...
expression_wide2 <- expression_wide %>%
  ...
  dplyr::select(study_number, Gender, StudyName, symbol_ensembl_gene_list_qc, expression_value_sample)
...
saveWorkbook(wb, paste0(OUT_loc, "/", Today,".iph_area_vst_dgea_gender_significant_genes.xlsx"), overwrite = TRUE)
