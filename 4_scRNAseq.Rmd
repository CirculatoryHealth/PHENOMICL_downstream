...
# rm(original_metadata_df, merged_metadata_df, new_metadata_columns, new_meta_info_df)

```

```{r}
str(scRNAseqDataCEA39[[]])
...
- _ND6_ ==> _MTND6_, not found
- _TRIM49D1_ ==> _TRIM49DP_, not found
- _ND4L_ ==> _MTND4L_, not found
- _ATP8_ ==> _MTATP8_, not found
- _RNASE1_ ==> _RNS1_, not found
...
### Expression in cell communities: grouped by up- and down-regulation

Let's group this dotplot based on up- and down-regulation. First, we filter the target list for up- and down-regulated genes.
...
ordered_genes_qc <- c(down_genes, up_genes)
```
...
p1
# Save the plots
ggsave(paste0(PLOT_loc, "/", Today, ".DotPlot.Targets.SignificanceGrouped.png"), plot = p1)
ggsave(paste0(PLOT_loc, "/", Today, ".DotPlot.Targets.SignificanceGrouped.ps"), plot = p1)
ggsave(paste0(PLOT_loc, "/", Today, ".DotPlot.Targets.SignificanceGrouped.pdf"), plot = p1)
